            ...
            <div className="contact-me-content">
                ...
                <div className="contact-me-left">
                    ...
                    <div className="contact-details">
                        <p><img src="../assets/icons/gmail.png" alt="Email Icon" className="contact-icon" /> Email: pallav.avatarit12@gmail.com</p>
                        <p><img src="../assets/icons/phone-call.png" alt="Phone Icon" className="contact-icon" /> Phone: +91 7077105233</p>
                    </div>
